...
namespace Markup
{
    ...
    {
        // This needs to be a querystring arg situation. And if you change the arg names, you need to
        // change HandlerArgs below
        public const string ResourceHandlerUrl = "markup.resource";

        public static List<string> JsExtensions = new List<string>() { ".js" };
        public static List<string> CssExtensions = new List<string>() { ".css" };

        // This is NOT the extension mapping for MarkupFile. This is list of extensions that
        // MarkupArchiveFile looks for to find its base content.
